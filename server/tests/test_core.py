...
class testOperationsCore(unittest.TestCase):  
    ...
    def setUp(self):
        ...
        self.tweet3 = 'Ολοκληρώθηκε ο <a href="https://twitter.com/hashtag/απεγκλωβισμός">#απεγκλωβισμός</a> τραυματισμένου'\
        ...
        self.tweet4 = 'Κατεσβέσθη <a href="https://twitter.com/hashtag/πυρκαγιά">#πυρκαγιά</a> σε μονοκατοικία στην'\
        ...
        self.tweet5 = '<a href="https://twitter.com/hashtag/Πυρκαγιά🔥">#Πυρκαγιά🔥</a> σε αγροτοδασική έκταση στην Δ.Ε.'\
        ...
        self.tweet6 = '''Οδηγίες της Ελληνικής Αστυνομίας για την αντιμετώπιση της ενδοοικογενειακής βίας. 
...
🎥</a> <a href="https://t.co/rrXIIdhXxA">https://t.co/rrXIIdhXxA</a>'''
        self.tweet7 = '''Από αστυνομικούς του Τμήματος Ασφαλείας Χαλκίδας, συνελήφθη ένα άτομο, διότι σε ειδική κρύπτη του οχήματός του, εντοπίστηκαν 11 κιλά ηρωίνης.
...
https://t.co/JzeY8yJhpH'''
        ...
        self.plain_text1 = 'Κατεσβέσθη πυρκαγιά σε κεραμοσκεπή οικίας, στο δήμο Κατερίνης Πιερίας.'\
        ' Επιχείρησαν 15 πυροσβέστες με 5 οχήματα.'
        self.plain_text2 = 'Σε εξέλιξη επιχείρηση ανάσυρσης ατόμου από αμαξοστοιχία τρένου στο Κρυονέρι Αττικής.'\
        ' Επιχειρούν 6 πυροσβέστες με 2 οχήματα.'
        self.plain_text3 = 'Ολοκληρώθηκε ο απεγκλωβισμός τραυματισμένου ατόμου από Ε.Ι.Χ. αυτοκίνητο και παραδόθηκε στο ΕΚΑΒ, συνεπεία τροχαίου, στη Δ.Ε. Παλιανής διαστάυρωση Άγιος Θωμάς Ηρακλείου Κρήτης. Επιχείρησαν 9 πυροσβέστες με 3 οχήματα.'
        self.plain_text4 = 'Κατεσβέσθη πυρκαγιά σε μονοκατοικία στην Τ.Κ. Φανού, στο δήμο Αμύνταιου, Φλώρινας. Επιχείρησαν 6 πυροσβέστες με 3 οχήματα.'
        self.plain_text5 = 'Πυρκαγιά σε αγροτοδασική έκταση στην Δ.Ε. Ιεράπετρας Κρήτης. Άμεσα'\
        ' κινητοποιήθηκαν 30 πυροσβέστες με 11 οχήματα και 1 ομάδα πεζοπόρου τμήματος. Συνδρομή από υδροφόρες Ο.Τ.Α.'
        self.plain_text6 = 'Οδηγίες της Ελληνικής Αστυνομίας για την αντιμετώπιση της ενδοοικογενειακής βίας. Βρείτε βοήθεια εδώ'
        self.plain_text7 = 'Από αστυνομικούς του Τμήματος Ασφαλείας Χαλκίδας, συνελήφθη ένα άτομο, διότι σε ειδική κρύπτη'\
        ' του οχήματός του, εντοπίστηκαν 11 κιλά ηρωίνης. Η σύλληψή του πραγματοποιήθηκε, μετά από καταδίωξη, στη Νέα Εθνική Οδό Αθηνών Λαμίας.'
    ...
    def test_get_capital_words(self):
        self.assertEqual(get_capital_words(self.plain_text1), 'Κατερίνης Πιερίας')
